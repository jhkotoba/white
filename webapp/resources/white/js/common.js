...
/* textarea code */
function textareaAddColor(type, data){
	...
	for(let i=0; i<strList.length; i++){				
		temp = strList[i].replace("//", "<span style='color:#6BA980;'>//")+"</span><br>";
		temp = replaceAll(temp, "function", "<span style='color:#6FC5EE; font-weight:bold !important;'>function</span>");
		str += temp;
	}
